...
static const char *colors[][3]      = {
  ...
  [SchemeTagsNorm]  = { nord4, nord0,  nord0  }, // Tagbar left unselected {text,background,not used but cannot be empty}
  [SchemeInfoSel]  = { nord8, nord1,  nord1  }, // infobar middle  selected {text,background,not used but cannot be empty}
  [SchemeInfoNorm]  = { nord4, nord1, nord1 }, // infobar middle  unselected {text,background,not used but cannot be empty}
};
...
static Key keys[] = {
  ...
  { MODKEY|ShiftMask,             XK_s,      spawn,          {.v = "/usr/bin/flameshot gui"} },
  { MODKEY,                       XK_p,      spawn,          {.v = "/usr/bin/flameshot full -c"} },
